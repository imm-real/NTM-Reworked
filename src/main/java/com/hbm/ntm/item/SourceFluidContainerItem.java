...
public final class SourceFluidContainerItem extends Item {
    ...
    public enum ContainedFluid {
        ...
        GASOLINE("gasoline", "hbmfluid.gasoline", 0x2F7747, 0xFFFFFF, ModFluids.GASOLINE::get),
        GASOLINE_LEADED("gasoline_leaded", "hbmfluid.gasoline_leaded", 0x2F775A, 0xFFFFFF,
                ModFluids.GASOLINE_LEADED::get),
        COALGAS("coalgas", "hbmfluid.coalgas", 0x2E155F, 0xFFFFFF, ModFluids.COALGAS::get),
        COALGAS_LEADED("coalgas_leaded", "hbmfluid.coalgas_leaded", 0x1E155F, 0xFFFFFF,
